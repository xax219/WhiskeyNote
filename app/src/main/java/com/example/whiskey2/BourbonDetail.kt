...
class BourbonDetail : ComponentActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContent {
            val bourbon = intent.getParcelableExtra<ParcelableBourbon>("bourbon")
            if (bourbon != null) {
                DetailContent3(bourbon)
            }
        }
    }
}
...
@Composable
fun DetailContent3(bourbon: ParcelableBourbon) {
    val imageUriString = bourbon.imageUri
        ...
        Box(
            ...
            Image(
                ...
                modifier = Modifier
                    ...
                    .clickable(onClick = {
                        val intent = Intent(context, BourbonList::class.java)
